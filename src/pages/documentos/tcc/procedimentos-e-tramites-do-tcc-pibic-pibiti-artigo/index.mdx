...
title: '
   Procedimentos e trâmites do TCC - PIBIC/PIBITI/Artigo — Campus Arapiraca
  '
---
...
2. O orientador deve montar uma banca para definir a nota do trabalho. A banca deve ter pelo menos um membro docente do curso de Ciência da Computação do
 *campus* 
 Arapiraca.
