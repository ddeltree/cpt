...
1. Antes de solicitar o ajuste leia [aqui](copy_of_instrucoes-para-sua-matricula) as instruções gerais para matrícula.
...
7. Os formulários estão na página do curso no link: [https://arapiraca.ufal.br/graduacao/ciencia-da-computacao/discentes/formularios-alunos/formularios-para-ajuste-de-matricula.](../formularios-alunos/formularios-para-ajuste-de-matricula)
